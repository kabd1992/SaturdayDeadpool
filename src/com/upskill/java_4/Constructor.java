...
public class Constructor {
	...
	- 	We use constructor for initializing objects
	*/
	String studentName;
	int studentAge;
	...
	public static void main(String[] args) {
		...
		Constructor obj = new Constructor("khaled", 30);
		System.out.println(obj.studentName);
		System.out.println(obj.studentAge);
	
		Constructor obj1 = new Constructor("Razzak", 35);
		System.out.println(obj1.studentName);
		System.out.println(obj1.studentAge);
	
		Constructor obj2 = new Constructor("fahim");
